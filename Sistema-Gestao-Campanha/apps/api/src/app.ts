...
app.get('/api/docs', (_request, response) =>
  response.json({
    ...
    resources: ['/auth', '/dashboard', '/people', '/coverage', '/coverage/macro', '/coverage/tree', '/coverage/cities/:cityId/detail', '/coverage/alliances/:allianceId/detail', '/boards', '/tasks', '/calendar-events', '/deliveries', '/imports', '/reconciliation-issues', '/product-decisions', '/audit-logs'],
